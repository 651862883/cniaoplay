package com.zhangjun.cniaoplay.ui.widget;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                int progressColor = a.getColor(R.styleable.LoadingButton_progressColor, getResources().getColor(R.color.white));
                setProgressColor(progressColor);

                int textColor = a.getColor(R.styleable.LoadingButton_textColor, getResources().getColor(R.color.white));
